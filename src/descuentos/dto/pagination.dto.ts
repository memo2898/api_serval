...
export class DescuentoFiltersDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ 
    example: true, 
    description: 'Filtrar por requiere_autorizacion' 
  })
  @IsOptional()
  @Transform(({ value }) => {
  ...
  @ApiPropertyOptional({ 
    ...
    description: 'Filtrar por fecha_inicio exacto (ISO string)' 
  })
  @IsOptional()
  @IsString()
  fecha_inicio?: string;
  ...
  @ApiPropertyOptional({ 
    example: '2024-01-01T00:00:00.000Z', 
    description: 'Filtrar por fecha_fin exacto (ISO string)' 
  })
  @IsOptional()
  @IsString()
  fecha_fin?: string;
