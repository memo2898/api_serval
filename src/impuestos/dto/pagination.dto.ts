...
export class ImpuestoFiltersDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ 
    example: 1, 
    description: 'Filtrar por pais_id' 
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  ...
  @ApiPropertyOptional({ 
    example: 10.5, 
    description: 'Filtrar por porcentaje' 
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  ...
  @ApiPropertyOptional({ 
    example: 'estándar', 
    description: 'Filtrar por tipo_aplicacion (búsqueda parcial)' 
  })
  @IsOptional()
  @IsString()
